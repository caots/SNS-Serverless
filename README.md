...
```bash
curl --request POST 'https://qj4izzk9t1.execute-api.us-east-1.amazonaws.com/dev/SNSResponseSendMessage' --header 'Content-Type: application/json' --data-raw '{"name": "John"}'
```
